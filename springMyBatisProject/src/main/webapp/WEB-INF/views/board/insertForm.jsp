...
<body>
	...
	<div class="board-container">
		...
		<form action="/board/insert" method="post">
			<label class="form-label">Title. 제목</label> <input type="text"
				name="title" class="input-box" placeholder="멋진 제목을 지어주세요!" required>

			<label class="form-label">Name. 작성자</label> <input type="text"
				name="writer" class="input-box" placeholder="닉네임을 입력하세요" required>

			<label class="form-label">Content. 내용</label>
			<textarea name="content" class="input-box"
				placeholder="어떤 소식을 공유하고 싶나요?"></textarea>

			<div class="btn-group">
				<a href="/board/boardList" class="custom-btn bg-list">📋 리스트</a>
    
    <button type="submit" class="custom-btn bg-send">🚀 등록하기</button>
    
    <button type="reset" class="custom-btn bg-reset">🧹 다시쓰기</button>
			</div>
		</form>
	</div>
